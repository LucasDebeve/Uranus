 ...
 */
final class Version20240520124738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plan_de_travail (id INT NOT NULL, titre VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
