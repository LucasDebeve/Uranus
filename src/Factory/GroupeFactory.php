...
final class GroupeFactory extends ModelFactory
{
    ...
    {
        // Suite de lettre aléatoire
        return [
            'titre' => self::faker()->sentence(2),
            // Le responsable est soit un professeur, soit un administrateur
            'responsable' => UserFactory::random() ?? UserFactory::new(),
        ];
    }
